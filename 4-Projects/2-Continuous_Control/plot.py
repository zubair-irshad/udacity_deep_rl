...
df = pd.read_csv('/home/mirshad7/deep-reinforcement-learning/p1_navigation/logging/nav_dqn_scores_20200510-001226.csv')
print(df.iloc[:].to_numpy().squeeze().shape)
